...
;
; File: Project 6: "Game Gravity"
;===============================================================================

; Bugs found: When scrolling the screen, sometimes the wall detection is not found
; and sprite passes through it.
; Otherwise when joystick is moved left/right or idle
; the sprite continues to fall. (WORKING)

; Sprite animation looping is off. The animation is running fast
; Sprite Idle animation is not showing.


; SPRITE PASSES THROUGH WALLS WHEN THE SCREEN IS SCROLLING
; Check the deltas left/right and make sure the tiles 0-3 are being checked
; Compare to original Spelunker to keep consistency.
